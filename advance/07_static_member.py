...
# 원본의 내용을 고치고 싶다면? 원본으로 직접 가저 고쳐야 한다.
Robot.count = 1000
# 원본(static)영역에서 고쳤을때 당연히 복사본영역에서는 영향이 없다.
...
Robot.std_count() # TypeError: Robot.std_count() missing 1 required positional argument: 'self'